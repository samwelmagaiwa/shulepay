...
class TransportController extends Controller {
    ...
    {
        if ($request->filled('school_id')) return (int) $request->school_id;
    ...
    public function vehicleSummary(Request $request) {
        ...
        return response()->json([
            ...
            'students_on_transport' => StudentTransportSubscription::when($schoolId, fn($q) =>
                $q->whereHas('vehicle', fn($v) => $v->where('school_id', $schoolId))
